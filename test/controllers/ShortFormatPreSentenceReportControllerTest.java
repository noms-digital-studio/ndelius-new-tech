...
public class ShortFormatPreSentenceReportControllerTest extends WithApplication {
    ...
    public void getSampleReportWithDocumentIdDecryptsAndRetrievesFromStore() {
        ...
        try {
            ...
            val documentId = URLEncoder.encode(Encryption.encrypt(clearDocumentId, secretKey).orElse(""), "UTF-8");
            val onBehalfOfUser = URLEncoder.encode(Encryption.encrypt(clearUserName, secretKey).orElse(""), "UTF-8");
            ...
            assertTrue(content.contains(Encryption.encrypt("Retrieved From Store", secretKey).orElse("")));   // Returned from Mock retrieveOriginalData
    ...
    public void postSampleReportPage2AllFieldsReturnsOK() {
        ...
        Function<String, String> encrypter = plainText -> Encryption.encrypt(plainText, "ThisIsASecretKey").orElse("");
